...
class CountryGapFillGame extends StatefulWidget {
  const CountryGapFillGame({super.key});
  @override
  State<CountryGapFillGame> createState() => _CountryGapFillGameState();
}
...
class _CountryGapFillGameState extends State<CountryGapFillGame> {
  final r = Random();
  ...
  void _setup() {
    _items = [
      _Item(
        parts: ['I am ', ' . I am from ', '.'],
        options: [
          ['Indonesian', 'Indonesia', 'Indonesia people'],
          ['Indonesia', 'Indonesian', 'Indonesias'],
        ],
        answers: ['Indonesian', 'Indonesia'],
      ),
      _Item(
        parts: ['They speak ', ' in ', '.'],
        options: [
          ['Portuguese', 'Spain', 'French'],
          ['Brazil', 'Spain', 'France'],
        ],
        answers: ['Portuguese', 'Brazil'],
      ),
      _Item(
        parts: ['Paris is the capital of ', '.', ''],
        options: [
      ...
      _Item(
        parts: ['He is ', ' but lives in ', '.'],
        options: [
          ['Japanese', 'Japan', 'Japanish'],
          ['Canada', 'Canadian', 'Canadas'],
        ],
        answers: ['Japanese', 'Canada'],
      ),
    ];
