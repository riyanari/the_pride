...
class MapDirMatchGame extends StatefulWidget {
  const MapDirMatchGame({super.key});
  @override
  State<MapDirMatchGame> createState() => _MapDirMatchGameState();
}

class _MapDirMatchGameState extends State<MapDirMatchGame> {
  final r = Random();
  ...
  void _setup() {
    final pool = List<MapDirVocab>.of(kMapDirVocab)..shuffle(r);
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          infoBadge(icon: Icons.touch_app, text: 'Pilih ARTI (chips), lalu ketuk KARTU istilah Inggris yang cocok.'),
