...
class MapDirFlashcardGame extends StatefulWidget {
  const MapDirFlashcardGame({super.key});
  @override
  State<MapDirFlashcardGame> createState() => _MapDirFlashcardGameState();
}

class _MapDirFlashcardGameState extends State<MapDirFlashcardGame> {
  final r = Random();
  late List<MapDirVocab> _deck;
  int _i = 0;
  int _known = 0;
  ...
  void _setup() {
    _deck = List<MapDirVocab>.of(kMapDirVocab)..shuffle(r);
    _deck = _deck.take(24).toList();
                ...
                child: AnimatedContainer(
                  ...
                  child: _showBack
                    ...
                    children: [
                      ...
                      Text(v.category.replaceAll('_', ' '), style: primaryTextStyle.copyWith(fontSize: 12, color: Colors.grey[700])),
                      const Spacer(),
