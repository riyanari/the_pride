...
class QuestionGapFillGame extends StatefulWidget {
  const QuestionGapFillGame({super.key});

  @override
  State<QuestionGapFillGame> createState() => _QuestionGapFillGameState();
}
...
class _QuestionGapFillGameState extends State<QuestionGapFillGame> {
  final _rand = Random();
  ...
  void _initData() {
    _items = [
      _GapItem(
        parts: ['___ is your favorite color?', ''],
        optionsPerBlank: [['What','Which','Who']],
        answers: ['What'],
      ),
      _GapItem(
        parts: ['___ are you from?',''],
        optionsPerBlank: [['Where','When','Why']],
        answers: ['Where'],
      ),
      _GapItem(
        parts: ['___ much is this book?',''],
        optionsPerBlank: [['How many','How much','How old']],
        answers: ['How much'],
      ),
      _GapItem(
        parts: ['___ bag is this? It\'s Anna\'s.',''],
        optionsPerBlank: [['Whose','Whom','Which']],
        answers: ['Whose'],
      ),
      _GapItem(
        parts: ['___ long does it take to get there?',''],
        optionsPerBlank: [['How tall','How long','How far']],
        answers: ['How long'],
      ),
      _GapItem(
        parts: ['___ of these shirts do you prefer, the blue or the white?',''],
        optionsPerBlank: [['What','Which','Who']],
        answers: ['Which'],
      ),
    ];
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          _infoBadge(icon: Icons.extension, text: 'Lengkapi kalimat dengan question word yang tepat.'),
