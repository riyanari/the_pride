...
class HobbiesFlashcardsGame extends StatefulWidget {
  const HobbiesFlashcardsGame({super.key});

  @override
  State<HobbiesFlashcardsGame> createState() => _HobbiesFlashcardsGameState();
}

class _HobbiesFlashcardsGameState extends State<HobbiesFlashcardsGame> {
  final r = Random();
  late List<HobbyVocab> _queue;
  ...
  Widget _card(Color color, HobbyVocab v) {
    return Container(
              ...
              children: [
                if (v.imageAsset != null) ...[
                  ClipRRect(
                    ...
                    child: AspectRatio(
                      aspectRatio: 16/9,
                      child: Image.asset(v.imageAsset!, fit: BoxFit.cover,
                ...
                Text(v.term, style: primaryTextStyle.copyWith(fontSize: 24, fontWeight: FontWeight.bold)),
              ],
            ),
            secondChild: Column(
