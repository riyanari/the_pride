...
class JobsMcqGame extends StatefulWidget {
  const JobsMcqGame({super.key});

  @override
  State<JobsMcqGame> createState() => _JobsMcqGameState();
}

class _JobsMcqGameState extends State<JobsMcqGame> {
  final r = Random();
  ...
  void _generate() {
    ...
    _items = take.map((v) {
      final wrongs = (kJobsVocab.where((x) => x.indo != v.indo).toList()..shuffle(r))
