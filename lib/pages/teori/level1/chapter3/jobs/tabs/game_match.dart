...
class JobsMatchGame extends StatefulWidget {
  const JobsMatchGame({super.key});

  @override
  State<JobsMatchGame> createState() => _JobsMatchGameState();
}

class _JobsMatchGameState extends State<JobsMatchGame> {
  final r = Random();
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          infoBadge(icon: Icons.touch_app, text: 'Pilih TERJEMAHAN (chips), lalu ketuk KARTU kata Inggris yang cocok.'),
