...
class JobsFlashcardsGame extends StatefulWidget {
  const JobsFlashcardsGame({super.key});

  @override
  State<JobsFlashcardsGame> createState() => _JobsFlashcardsGameState();
}

class _JobsFlashcardsGameState extends State<JobsFlashcardsGame> {
  final r = Random();
  late List<JobVocab> _queue;
  ...
  Widget _card(Color color, JobVocab v) {
    return Container(
